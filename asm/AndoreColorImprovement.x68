...
; ORG         $75C00
  ...
  BNE.W       $75C28                    ; If it is not Andore type, go to the code from the original game below.
  ...
  LEA         $75C3A, A3                ; Stores the base address that contains the new color IDs of andore type enemies inside A3.
...
; After the last line (JMP) you need to add the 
; color pallete ID values.
;
; FF FF FF FF FF FF 0D 00 0E 1A 00 1B