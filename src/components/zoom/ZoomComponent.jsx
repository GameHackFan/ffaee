	...
	return (
		<div className="zoom rowLinedFlex">
			<label className="windowText">
				Use this window to edit the zoom of the components of 
				the editor, adjusting it in a way that makes it more 
				confortable to you. You can save and load a 'Preset' 
				with the changes you like.
			</label>
