...
const LevelEditorComponent = (props) =>
{
  ...
  const delayFieldStyle = leeg.mustHaveSpawnDelayTime ?
      {} : hidden;
  const verticalStyle = leeg.hasElevator ?
      {overflowY: "scroll"} : {};
  ...
  return (
    <div className="level rowLinedFlex">
      ...
      <label className="windowText">
        Here you can choose what enemy or item will spawn, you can change the position to trigger their spawn, you can change their X and Y positions, you can change their offensive and defensive behavior and you can change the spawn delay time.
      </label>
      <label className="windowText">
      ...
      <label className="windowText">
        The Trigger Position, Offensive Behavior, Deffensive Behavior and Spawn Delay Time always have a minimum and maximum value. The editor will allow you to insert any value you want but it will fix those values to be the maximum or the minimum possible to avoid bugs. It is recommended that you always insert valid values between the maximum and the minimum to avoid having surprises about the enemies being automatically moved by the editor when you apply the customizations. Spawn Delay Time is used only by 'Lock' or 'Boss Helper' enemy groups, so it will not always be available to edit.
      </label>
      <label className="windowText">
        If you want to edit a ROM and then change it later, save a preset file and load it later so you don't lose your customizations.
      </label>
      <label
      ...
      >
        ...
        <div className="enemyGroupText">
          ...
          <span> {leeg.maxAmount}</span>
          <label>
            , the editor will remove the extra object(s) to avoid the game to be overloaded.
          </label>
        </div>
        ...
        >
          ...
          >
            ...
            <input
              ...
              className="textfield"
              value={enemy.offensiveBehavior ? 
                  enemy.offensiveBehavior : ""}
              onChange={props.handleEnemyDataChange}
            />
          ...
          >
            ...
            <input
              ...
              className="textfield"
              value={enemy.defensiveBehavior ? 
                  enemy.defensiveBehavior : ""}
              onChange={props.handleEnemyDataChange}
            />
            <span>(Minimum = 0, Maximum = 255)</span>
          </div>
          ...
          >
            ...
            <input
              ...
              name="spawnDelayTime"
              className="textfield"
              value={enemy.spawnDelayTime ? 
                  enemy.spawnDelayTime : ""}
              onChange={props.handleEnemyDataChange}
            />
