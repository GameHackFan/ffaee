const level3EnemyGroup =
{
  ...
  group4:
  {
    ...
    defaultAmount: 0,
    maxAmount: 10,
    forbiddenPositionRanges:["outsideLeft"],   forbiddenEnemyLists: ["mustSpawnLeftList"]
  },
  group5:
  {
    label: "Enemy Group 5",
  ...
  group6:
  {
    ...
    extraBoss: "ediE",
    forbiddenPositionRanges:["outsideLeft"],    forbiddenEnemyLists: ["chandelierList",
        "mustSpawnLeftList"]
  },
  ...
  bossHelperGroup1:
  {
    ...
    maxAmount: 20,
    specialProfile: "lockGroupStrategy",
    forbiddenPositionRanges:["outsideRight"],    forbiddenEnemyLists: ["chandelierList",
        "mustSpawnRightList", "staticObjectList"]
  },
  bossHelperGroup2:
  {
